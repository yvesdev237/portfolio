...
const Skill = () => {
  const skills = [
    ...
    },
    {
      title: "CSS",
      level: 78,
      icon: <FaCss3 className="size-5 text-blue-400" />,
    },
    {
      title: "JavaScript",
      level: 70,
    ...
    },
    {
      title: "Node.js",
      level: 35,
      icon: <FaNodeJs className="size-5 text-emerald-400" />,
    },
    {
      title: "Databases",
      level: 48,
      icon: <FaDatabase className="size-5 text-emerald-600" />,
    },
    {
      title: "UI/UX design",
      level: 62,
      icon: <FaFigma className="size-5 text-white" />,
    },
  ];
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="space-y-4">
          {categories.map((category) => (
            <div
              key={category.title}
              className="rounded-[24px] border border-white/10 bg-slate-900/70 p-4"
            >
