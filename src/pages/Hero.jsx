...
const Hero = ({ parallaxOffset = 0 }) => {
  const highlights = ['React', 'Tailwind CSS', 'UI motion', 'Responsive design']
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="relative mt-8 overflow-hidden rounded-[32px] border border-white/10 bg-slate-950/70 px-5 py-10 shadow-[0_20px_80px_rgba(2,12,27,0.4)] backdrop-blur-xl sm:px-8 sm:py-14 lg:mt-16 lg:px-10 lg:py-16"
    >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-lg leading-8 text-slate-300 sm:text-xl">
              I’m Yves, a frontend developer crafting elegant interfaces, smooth motion and memorable user journeys that feel effortless on desktop and tablet.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <a href="#projects" className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-cyan-400 to-blue-600 px-5 py-3 font-semibold text-slate-950 transition hover:scale-[1.01]">
              <FaCode /> View my work
            </a>
            <a href="#contact" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-3 font-semibold text-slate-200 transition hover:border-cyan-300/40 hover:bg-cyan-400/10">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-semibold text-white">Fast products, clear storytelling</h2>
            </div>
          ...
          <div className="mt-6 rounded-2xl border border-cyan-400/20 bg-gradient-to-r from-cyan-400/10 to-blue-600/10 p-4">
            <p className="text-sm uppercase tracking-[0.24em] text-cyan-200">Now shipping</p>
            <p className="mt-2 text-lg text-slate-100">Modern landing pages, portfolio upgrades and interactive web apps.</p>
          </div>
        </motion.div>
      </div>
    </motion.section>
