  ...
  return (
    <motion.section initial = {{opacity : 0 , y : 50}} whileInView={{opacity : 1 , y: 0}} transition={{duration: 2.6}} viewport={{once : true}} className='w-full mt-40 h-96 flex flex-col justify-center items-center p-3'>
        ...
        <div className='w-full mt-10 flex flex-col space-y-5 items-center'>
          <a href='#projects' className='w-[80%] p-3 px-7 text-lg rounded-2xl bg-violet-700 backdrop:blur-3xl shadow-sm shadow-gray-50 hover:ring-2 hover:ring-white flex gap-3 justify-start items-center capitalize '>
            <FaFolderOpen className='size-5'/>
            <p className='font-light'>view my work</p>
          </a>
        <a href='#contact' className='w-[80%] p-3 px-7 text-lg rounded-2xl bg-violet-700 backdrop:blur-3xl shadow-sm shadow-gray-50 hover:ring-2 hover:ring-white flex gap-3 justify-start items-center capitalize '>
